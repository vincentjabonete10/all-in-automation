...
export declare const CPU_IDLE_TRESHOLD = 15000;
...
export declare const UNSUPPORTED_ERROR_MESSAGE = "The @wdio/devtools-service currently only supports Chrome version 63 and up, Firefox 86 and up, and Chromium as the browserName!";
